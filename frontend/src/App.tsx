...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic Space Satellite Orbit & Conjunction Planner</h1>
      <p>Multi-agent space debris tracking, satellite orbit maneuver calculator, and conjunction alert agent.</p>
